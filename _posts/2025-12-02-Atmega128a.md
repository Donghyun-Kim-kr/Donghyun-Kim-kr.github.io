...
If you want to find more information of Time Timer, Click above link.

<img width="500" height="500" alt="Image" src="https://github.com/user-attachments/assets/f4b317fc-ab9f-4bfc-8a5d-68c27dea7eb1" />

---

## requirements

- Microchip studio (Atmel studio 7.0) (Or similar AVR development environments)

- KD128-pro (atmega128a) board
  
  - you can make a board by own your hands with atmega128a & Peripherals . but I used pre-designed board 
...
- Mode select by External Interrupts
  
  - Start/Pause
  
  - Reset
  
  - Time Setting mode/complete setting
  
  - Mute/Beep

- Time setting feature using variable resistor by ADC conversion (00:00~60:00)

- Sound (button feedback, Beep mode alarm) by PWM
...
<img width="777" height="429" alt="Image" src="https://github.com/user-attachments/assets/86a9d84f-ed8e-4574-83e0-12ca23f57ed8" />

<img width="757" height="570" alt="Image" src="https://github.com/user-attachments/assets/4a91a849-2a02-444b-b61b-af40f8196a3f" />
...
When I was first coded, I just make Timer feature and It's well-operating.  

And then, I added 4 External interrupt features, debouncing code, and timer etc...

I thought that it doesn't have any problems.  

But, When I pressed button, it doesn't operating sometimes.  

  

My hypothesis : Timing issue that caused by too many ISR code.  

So, I choose the method that ISR just set the flag.  

And FSM state transition and Output operating are running in main function.  



### Why we use UL(unsigned Long), Volatile?

UL : when multiplying, I intended to leave space for result value.  

Volatile : to prevent the compiler from optimizing a variable.
